import { DateWrapper, StringWrapper, RegExpWrapper, NumberWrapper, isPresent } from '../../src/facade/lang';
...
export class Animation {
    ...
    addEvents() {
        if (this.totalTime > 0) {
            this.eventClearFunctions.push(getDOM().onAndCancel(this.element, getDOM().getTransitionEnd(), (event) => this.handleAnimationEvent(event)));
        }
        else {
