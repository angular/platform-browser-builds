...
export class WorkerDomAdapter extends DomAdapter {
    ...
    querySelector(el /** TODO #9100 */, selector) { throw "not implemented"; }
    querySelectorAll(el /** TODO #9100 */, selector) { throw "not implemented"; }
    on(el /** TODO #9100 */, evt /** TODO #9100 */, listener /** TODO #9100 */) { throw "not implemented"; }
    onAndCancel(el /** TODO #9100 */, evt /** TODO #9100 */, listener /** TODO #9100 */) { throw "not implemented"; }
    ...
    replaceChild(el /** TODO #9100 */, newNode /** TODO #9100 */, oldNode /** TODO #9100 */) { throw "not implemented"; }
    remove(el /** TODO #9100 */) { throw "not implemented"; }
    insertBefore(el /** TODO #9100 */, node /** TODO #9100 */) { throw "not implemented"; }
    insertAllBefore(el /** TODO #9100 */, nodes /** TODO #9100 */) { throw "not implemented"; }
    ...
    createElement(tagName /** TODO #9100 */, doc /** TODO #9100 */) { throw "not implemented"; }
    createElementNS(ns, tagName, doc /** TODO #9100 */) { throw "not implemented"; }
    createTextNode(text, doc /** TODO #9100 */) { throw "not implemented"; }
    createScriptTag(attrName, attrValue, doc /** TODO #9100 */) {
        throw "not implemented";
    }
    createStyleElement(css, doc /** TODO #9100 */) { throw "not implemented"; }
    ...
    getElementsByClassName(element /** TODO #9100 */, name) { throw "not implemented"; }
    getElementsByTagName(element /** TODO #9100 */, name) { throw "not implemented"; }
    ...
    setStyle(element /** TODO #9100 */, styleName, styleValue) { throw "not implemented"; }
    removeStyle(element /** TODO #9100 */, styleName) { throw "not implemented"; }
    getStyle(element /** TODO #9100 */, styleName) { throw "not implemented"; }
    hasStyle(element /** TODO #9100 */, styleName, styleValue) { throw "not implemented"; }
    tagName(element /** TODO #9100 */) { throw "not implemented"; }
    attributeMap(element /** TODO #9100 */) { throw "not implemented"; }
    hasAttribute(element /** TODO #9100 */, attribute) { throw "not implemented"; }
    hasAttributeNS(element /** TODO #9100 */, ns, attribute) { throw "not implemented"; }
    getAttribute(element /** TODO #9100 */, attribute) { throw "not implemented"; }
    getAttributeNS(element /** TODO #9100 */, ns, attribute) { throw "not implemented"; }
    setAttribute(element /** TODO #9100 */, name, value) { throw "not implemented"; }
    setAttributeNS(element /** TODO #9100 */, ns, name, value) { throw "not implemented"; }
    removeAttribute(element /** TODO #9100 */, attribute) { throw "not implemented"; }
    removeAttributeNS(element /** TODO #9100 */, ns, attribute) { throw "not implemented"; }
    ...
    resolveAndSetHref(element /** TODO #9100 */, baseUrl, href) { throw "not implemented"; }
