...
import { PLATFORM_DIRECTIVES, PLATFORM_PIPES, ExceptionHandler, APPLICATION_COMMON_PROVIDERS, PLATFORM_COMMON_PROVIDERS, OpaqueToken, RootRenderer, getPlatform, createPlatform, assertPlatform, ReflectiveInjector } from '@angular/core';
