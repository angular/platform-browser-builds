...
import { ApplicationRef, ReflectiveInjector, getPlatform, createPlatform, assertPlatform } from '@angular/core';
import { WORKER_RENDER_APPLICATION_PROVIDERS } from './webworker/worker_render';
import { WORKER_SCRIPT, WORKER_RENDER_PLATFORM_PROVIDERS, WORKER_RENDER_PLATFORM_MARKER } from './webworker/worker_render_common';
