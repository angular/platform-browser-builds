...
import { ɵglobal, NgZone, createPlatformFactory, platformCore, NgModule, APP_ID, ɵdefineNgModule, defineInjector, ɵsetClassMetadata, PLATFORM_INITIALIZER } from '@angular/core';
...
/** @nocollapse */ BrowserTestingModule.ngModuleDef = ɵdefineNgModule({ type: BrowserTestingModule, bootstrap: [], declarations: [], imports: [], exports: [BrowserModule] });
