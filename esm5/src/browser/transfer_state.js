...
var BrowserTransferStateModule = /** @class */ (function () {
    ...
    BrowserTransferStateModule.ngInjectorDef = i0.ΔdefineInjector({ factory: function BrowserTransferStateModule_Factory(t) { return new (t || BrowserTransferStateModule)(); }, providers: [{ provide: TransferState, useFactory: initTransferState, deps: [DOCUMENT, APP_ID] }] });
