 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */n.setup();var i=t.createPlatformFactory(t.platformCore,"browserTesting",[{provide:t.PLATFORM_INITIALIZER,useValue:function u(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]),f=function(){return function n(e,t,r,o){var i,u=arguments.length,f=u<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)f=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(f=(u<3?i(f):u>3?i(t,r,f):i(t,r))||f);return u>3&&f&&Object.defineProperty(t,r,f),f}([t.NgModule({exports:[r.BrowserModule],providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:o}]})],function e(){})}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
