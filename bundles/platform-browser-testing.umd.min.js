...
/**
     ...
     */
function a(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]),f=function(){function e(){}return e.ɵmod=t.ɵɵdefineNgModule({type:e}),e.ɵinj=t.ɵɵdefineInjector({factory:function t(r){return new(r||e)},providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:i}],imports:[r.BrowserModule]}),e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BrowserTestingModule=f,e.platformBrowserTesting=u,Object.defineProperty(e,"__esModule",{value:!0})}));