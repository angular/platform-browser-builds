...
/**
     ...
     */
function a(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]),f=function(){function e(){}return e.ɵmod=t.ɵɵdefineNgModule({type:e}),e.ngInjectorDef=t.ɵɵdefineInjector({factory:function t(r){return new(r||e)},providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:i}],imports:[r.BrowserModule]}),e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
