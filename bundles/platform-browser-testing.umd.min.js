...
/**
     ...
     */
function a(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]);(i=function i(){}).ɵmod=t.ɵɵdefineNgModule({type:i}),i.ɵinj=t.ɵɵdefineInjector({factory:function e(t){return new(t||i)},providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:function f(){return new t.NgZone({enableLongStackTrace:!0,shouldCoalesceEventChangeDetection:!1})}}],imports:[r.BrowserModule]}),("undefined"==typeof ngJitMode||ngJitMode)&&t.ɵɵsetNgModuleScope(i,{exports:[r.BrowserModule]}),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BrowserTestingModule=i,e.platformBrowserTesting=u,Object.defineProperty(e,"__esModule",{value:!0})}));