...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */o.setup();var i=t.createPlatformFactory(t.platformCore,"browserTesting",[{provide:t.PLATFORM_INITIALIZER,useValue:function u(){r.ɵBrowserDomAdapter.makeCurrent(),o.setup()},multi:!0}]),a=function(){function e(){}return e.ngModuleDef=t.ɵdefineNgModule({type:e,exports:[r.BrowserModule]}),e.ngInjectorDef=t.defineInjector({factory:function t(r){return new(r||e)},providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:n}],imports:[[r.BrowserModule]]}),e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
