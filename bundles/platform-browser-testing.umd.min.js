...
/**
     ...
     */
function u(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]),a=function(){function e(){}return e.ngModuleDef=t.ɵɵdefineNgModule({type:e}),e.ngInjectorDef=t.ɵɵdefineInjector({factory:function t(r){return new(r||e)},providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:o}],imports:[r.BrowserModule]}),e}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
