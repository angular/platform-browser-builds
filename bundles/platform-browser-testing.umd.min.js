...
/**
     ...
     */
function a(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]);(i=function i(){}).ɵfac=function e(t){return new(t||i)},i.ɵmod=t.ɵɵdefineNgModule({type:i}),i.ɵinj=t.ɵɵdefineInjector({providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:function f(){return new t.NgZone({enableLongStackTrace:!0,shouldCoalesceEventChangeDetection:!1})}}],imports:[r.BrowserModule]}),("undefined"==typeof ngJitMode||ngJitMode)&&t.ɵɵsetNgModuleScope(i,{exports:[r.BrowserModule]}),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
