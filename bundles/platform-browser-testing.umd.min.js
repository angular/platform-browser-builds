...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function a(){r.ɵBrowserDomAdapter.makeCurrent(),n.setup()},multi:!0}]),f=i,s=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{exports:[r.BrowserModule],providers:[{provide:t.APP_ID,useValue:"a"},r.ɵELEMENT_PROBE_PROVIDERS,{provide:t.NgZone,useFactory:f}]}]}],e}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.BrowserTestingModule=s,e.platformBrowserTesting=u,e.ɵ0=f,e.ɵangular_packages_platform_browser_testing_testing_a=i,Object.defineProperty(e,"__esModule",{value:!0})}));