...
/** @nocollapse */ TransferState.ngInjectableDef = i0.ΔdefineInjectable({ token: TransferState, factory: function TransferState_Factory(t) { return new (t || TransferState)(); }, providedIn: null });
...
/** @nocollapse */ BrowserTransferStateModule.ngModuleDef = i0.ΔdefineNgModule({ type: BrowserTransferStateModule });
/** @nocollapse */ BrowserTransferStateModule.ngInjectorDef = i0.ΔdefineInjector({ factory: function BrowserTransferStateModule_Factory(t) { return new (t || BrowserTransferStateModule)(); }, providers: [{ provide: TransferState, useFactory: initTransferState, deps: [DOCUMENT, APP_ID] }] });
