...
/** @nocollapse */ HammerGestureConfig.ngInjectableDef = i0.ΔdefineInjectable({ token: HammerGestureConfig, factory: function HammerGestureConfig_Factory(t) { return new (t || HammerGestureConfig)(); }, providedIn: null });
...
/** @nocollapse */ HammerGesturesPlugin.ngInjectableDef = i0.ΔdefineInjectable({ token: HammerGesturesPlugin, factory: function HammerGesturesPlugin_Factory(t) { return new (t || HammerGesturesPlugin)(i0.Δinject(DOCUMENT), i0.Δinject(HAMMER_GESTURE_CONFIG), i0.Δinject(i0.ɵConsole), i0.Δinject(HAMMER_LOADER, 8)); }, providedIn: null });
