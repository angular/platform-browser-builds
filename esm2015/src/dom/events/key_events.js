...
/** @nocollapse */ KeyEventsPlugin.ngInjectableDef = i0.ΔdefineInjectable({ token: KeyEventsPlugin, factory: function KeyEventsPlugin_Factory(t) { return new (t || KeyEventsPlugin)(i0.Δinject(DOCUMENT)); }, providedIn: null });
