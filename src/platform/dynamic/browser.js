...
/*@ts2dart_const*/ [
    browser_1.BROWSER_APP_COMMON_PROVIDERS,
...
function bootstrap(appComponentType, customProviders) {
    ...
    var appInjector = core_1.ReflectiveInjector.resolveAndCreate([exports.BROWSER_APP_PROVIDERS, lang_1.isPresent(customProviders) ? customProviders : []], browser_1.browserPlatform().injector);
